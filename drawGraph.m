function [x, y, labels] = drawGraph(adj, labels);
% drawGraph Automatic graph layout: interface to Neato (see http://www.graphviz.org/)
% [x, y, labels] = drawGraph(adjMat, labels)
%  
% Written by Leon Peshkin, Kevin Murphy,
% Tom Minka, Alexi Savov, Ali Taylan Cemgil, Erik A. Johnson 
% 1998--2004
